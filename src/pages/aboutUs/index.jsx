...
import { TermcreateApi, getApiCallToken, getApiCall, getTermsandCondition, postApiCall, postApiCallToken } from '../../API/baseUrl';
import CkEditor from '../../Components/ckEditor';
import SearchToolbar from '../../Components/Search/Search';
import { AboutHeading, TermsHeading } from '../../Components/Heading';
...
export default function About() {
    ...
    const handlePrivacyData = async () => {
        ...
        setLoading(true)
        try {
            // const result = await postApiCall(`${TermcreateApi}${id}`,{
